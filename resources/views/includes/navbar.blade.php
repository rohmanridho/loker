@guest
  ...
  <div class="container">
    <a class="navbar-brand font-weight-bolder " href="{{ route('home') }}" style="font-size: 27px; font-family: poppins, sans-serif; color: rgb(18, 51, 88);">JobStreet</a>
    ...
    <div class="collapse navbar-collapse d-md-flex justify-content-md-between " id="navbarNav">
      ...
      <ul class="navbar-nav align-items-center">
        <li class="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link font-weight-bold text-primary" href="{{ route('login') }}" style="padding: 5px; background-color: white; border-radius: 7px; margin-right: 10px;">Sign In</a>
        </li>
        
         <div class="garis_verikal d-none d-md-block"></div>
          <li class="nav-item">
            <a class="nav-link text-white" style="font-size: 15px;" href="#"
              >Empeloyer / Post Job</a
            >
          </li>
      </ul>
    </div>
...
@auth
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse d-md-flex justify-content-md-between " id="navbarNav">
      ...
      "></div>
         <li class="nav-item">
        <a class="nav-link text-white active" href="{{ route('admin-dashboard') }}" class="dropdown-item">Dashboard</a>
         </li>
         <li class="nav-item">
      ...
      <li class="nav-item">
          <a href="{{ route('logout') }}"
                        ...
                        {{ __('Logout') }}
                        class="nav-link text-center font-weight-bold text-primary" style="padding: 5px; background-color: white; border-radius: 7px;">Sign Out</a>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse d-md-flex justify-content-md-between " id="navbarNav">
      ...
      <ul class="navbar-nav align-items-center">
       ...
       <a class=" nav-link  bi bi-person-fill text-white" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="font-size: 23px; " >
       </a>
         <ul class="dropdown-menu" >
            <li><a class="dropdown-item font-weight-bold" href="#">Verify your account</a></li>
            <li><a class="dropdown-item " href="#">{{ Auth::user()->email }}</a></li>
            <li><a class="dropdown-item " href="{{ route('admin-dashboard') }}" class="dropdown-item"><i class="bi bi-grid-1x2-fill" style="padding-right: 10px;"></i> Dashboard</a></li>
            <li><a class="dropdown-item" href="{{ route('profile') }}"> <i class="bi bi-file-earmark-text-fill"  style= "padding-right: 10px;"></i> Profile</a></li>
            <li><a class="dropdown-item" href="{{ route('jobs') }}"><i class="bi bi-heart-fill" style= "padding-right: 10px;"></i> My jobs</a></li>
            <li><a class="dropdown-item" href="{{ route('account-settings') }}" ><i class="bi bi-gear-fill" style= "padding-right: 10px;"></i> Settings</a></li>
