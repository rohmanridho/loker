              ...
              <ul class="navbar-nav d-none d-lg-flex ml-auto">
                <li class="nav-item">
                  <span class="nav-link d-flex align-items-center mr-3">
                    <div class="d-flex rounded-circle mr-2" style="width: 40px; height: 40px; background: #0000ff10;"><span class="m-auto fw-bold" style="font-size: 24px;">{{ strtoupper(Auth::user()->name)[0] }}</span></div>
