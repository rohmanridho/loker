...
<div class="section-content" style="margin-top: 20px !important">
  <div class="container">
          ...
          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
              <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab"
                aria-controls="pills-home" aria-selected="true">My Jobs</a>
            </li>

          </ul>
          <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
              <div href="/dashboard-transactions-details.html" class="card card-list d-block mb-2">
                <div class="card-body">
                  <div class="row d-flex justify-content-between align-items-center">
                    <div class="col-md-9 d-flex align-items-center">
                      <div class="gambar">
                        <img src="/images/nielsen.jfif" alt="" />
                      </div>
                      <div class="brand align-items-center pl-2">
                        <h5 class="company">
                          NIELSEN
                        </h5>
                        <div class="jobs">
                    ...
                    <div class="col-md-2 col-12">
                      <button type="button" class="btn btn-warning rounded-2 w-full btn-block mb-2 mt-4"
                                ...
                                <div class="col-12">
                                  ...
                                  <div class="row">
                                    <div class="col-md-4 col-12">
                                      <div class="gambar">
                                        <img src="images/company.jpg" alt="" style="width: 130px"
                                          class="rounded-2 mb-3 ">
                                        <a href="" class="delete-gallery" style=" display: block;
                        position: absolute;
                        top: -10px;
                        right: 0;">
                           ...
                           right: 0;">
                                    ...
                                    <div class="col-md-4 col-12">
                                      <div class="gambar">
                                        <img src="images/gambar.png" alt="" style="width: 130px"
                                          class="rounded-2 mb-3 ">
                                        <a href="" class="delete-gallery" style=" display: block;
                        position: absolute;
                        top: -10px;
                      ...
                      <button href="" class="btn btn-danger rounded-2 w-full btn-block">
