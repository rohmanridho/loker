    ...
    <div class="row d-flex justify-content-between align-items-center">
      ...
      <div class="col-md-3 col-12">
        <div class="button">
          ...
          <button type="button" class="btn btn-outline-primary rounded-3 font-weight-bold" data-bs-toggle="modal"
            data-bs-target="#exampleModal">Make Review</button>
...
<div class="jobs-details-content">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-4 col-12 mb-3 " data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="col-md-4 col-12 mb-3 " data-aos="fade-up" data-aos-delay="200">
        <a href="{{ route('add-jobs') }}" class="card  text-decoration-none rounded-3 kotak">
          <div class="card-body">
            <div class="jobs">
      ...
      <div class="col-md-4 col-12 mb-3 " data-aos="fade-up" data-aos-delay="600">
        <a href="{{ route('add-jobs') }}" class="card  text-decoration-none rounded-3 kotak">
          <div class="card-body">
            <div class="jobs">
      ...
      <div class="col-md-4 col-12 mb-3 " data-aos="fade-up" data-aos-delay="700">
        <a href="{{ route('add-jobs') }}" class="card  text-decoration-none rounded-3 kotak">
          <div class="card-body">
            <div class="jobs">
      ...
      <div class="col-md-4 col-12 mb-3 " data-aos="fade-up" data-aos-delay="800">
        <a href="{{ route('add-jobs') }}" class="card  text-decoration-none rounded-3 kotak">
          <div class="card-body">
            <div class="jobs">
      ...
      <div class="col-md-4 col-12 mb-3 " data-aos="fade-up" data-aos-delay="900">
        <a href="{{ route('add-jobs') }}" class="card  text-decoration-none rounded-3 kotak">
          <div class="card-body">
            <div class="jobs">
