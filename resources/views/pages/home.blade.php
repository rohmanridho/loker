    ...
    <form action="" method="GET">
      <div class="row d-flex justify-content-center mb-4">
        <div class="col-12 col-md-8 mb-3">
          <input type="text" name="find-job" class="form-control job-search" placeholder="Search Job">
        </div>
                ...
                <div class="card-box mb-3">
                  <div class="card-content">
                    <div class="card-image mb-2">
                      <a href="">
                        <img
                          src="{{ Storage::url($job->company->photo) }}"
                          alt="">
                      </a>
                    </div>
                    <div class="job-name">
                    ...
                    <div class="company-name mb-2">
                      <a href="{{ route('company-detail', $job->company->slug) }}">{{ $job->company->name }}</a>
                    </div>
      ...
      @foreach ($industries as $industry)
          <div class="col-6 col-md-4 col-lg-3">
            <a href="#" class="d-block industries mb-4">
                <div style="background-image: url('{{ Storage::url($industry->photo) }}');"
                    class="back-img"></div>
