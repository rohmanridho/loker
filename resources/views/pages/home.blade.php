...
<section class="page-home mt-5">
        ...
        <div class="row">
            <div class="col-12">
                <div class="text-center mb-3">
                    <span class="">
                        <a href="{{ route('profile', Auth::user()->name) }}" class="fw-semibold">Post your Resume</a> -
                        it only
                        takes
                        sebentar
                    </span>
                ...
                <div class="row justify-content-center">
                                ...
                                <div class="card-box mb-3">
                                    <div class="card-content">
                                        <div class="card-image mb-2">
                                            <img src="{{ Storage::url($job->company->photo) }}"
                                                alt="{{ $job->company->name }}">
                                        </div>
                                        <div class="job-name">
                                            <a
                                                href="{{ route('job-detail', ['company' => $job->company->slug, 'slug' => $job->slug]) }}">{{
                                                $job->name }}</a>
                                        </div>
                    ...
                    <div class="col-12 col-md-5">
                        <a href="{{ route('search-job') }}"
                            class="btn btn-light btn-block fw-semibold mb-4 looking-for-job">Lihat
                            Lowongan Lebih
                            Banyak</a>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row mb-5">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <a href="{{ route('search-job', ['search' => $industry->name]) }}" class="d-block industries mb-4">
