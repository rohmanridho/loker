...
@section('title', 'Temukan Pekerjaan Impianmu | '. env('APP_NAME') .' ')
...
<section class="page-home mt-5">
  ...
  <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
      <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button"
        role="tab" aria-controls="home-tab-pane" aria-selected="true">For You</button>
    </li>
    <li class="nav-item" role="presentation">
      <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button"
        role="tab" aria-controls="profile-tab-pane" aria-selected="false">Popular
        searches</button>
    </li>
  </ul>
      ...
      <div class="container job-feed">
        <div class="row justify-content-center">
                ...
                <div class="card-box mb-3">
                  <div class="card-content">
                    <div class="card-image mb-2">
                        <img src="{{ Storage::url($job->company->photo) }}" alt="{{ $job->company->name }}">
                    </div>
                    <div class="job-name">
          ...
          <div class="col-12 col-md-5">
            <a href="{{ route('search-job') }}" class="btn btn-light btn-block fw-semibold mb-4 looking-for-job">Lihat
              Lowongan Lebih
              Banyak</a>
          </div>
        </div>
      ...
      <div class="container popular-searches mb-2">
        <div class="row d-flex justify-content-center">
          <div class="col-12 col-md-10 d-flex justify-content-center flex-wrap searches">
            ...
            <a href="{{ route('search-job', ['search' => $category->name]) }}" class="category"><i
          ...
          <div class="d-flex justify-content-center align-items-center">
            <div class="content text-center">
              <div class="w-100 d-flex justify-content-center mb-2">
                <img src="{{ Storage::url($company->photo) }}" alt="" class="d-block rounded company-image">
              </div>
  ...
  <div class="container">
    <div class="row my-3">
      <div class="col-12 text-center">
        <div class="fs-5 fw-bold mb-3">Industries</div>
      </div>
    </div>
    <div class="row mb-5">
